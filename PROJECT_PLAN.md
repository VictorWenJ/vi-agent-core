...
| P2-E | 进行中 | `execution-phase/phase-P2-E-prompt-governance/` | Prompt Engineering Governance |
...
P2-E 的目标是治理当前 P2 中已经出现的 prompt / prompt-like 能力。
...
- PromptRegistry
- PromptRenderer
- prompt schema 与 parser allowlist 一致性检查
- prompt audit metadata
- D-2 / D-3 inline prompt 向统一 prompt governance 结构迁移
